      ...
      <div className='flex flex-row items-center border border-gray-700 rounded-full bg-gray-900'>
        <span className='border-r border-gray-600 pr-2'>
          <input
            ...
            onKeyDown={(e) => e.key === "Enter" && handleSearch()} // allows pressing Enter
            className='rounded-md w-full p-2 border-none focus:outline-none active:outline-none text-white'
            type="text"
            placeholder='Search'
          />
        </span>
        <span
          className='text-xl cursor-pointer px-4 p-2 hover:text-emerald-500 rounded-r-2xl'
